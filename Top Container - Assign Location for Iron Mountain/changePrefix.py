...
barcodes_df = pd.read_excel(filename, dtype={'Barcode': str})

# barcodes_df['Barcode'] = barcodes_df['Barcode'].apply(lambda x: str(x))
...
for barcode in barcode_list:
    ...
    if "error" in top_container_search_results:
        ...
        if top_container_search_results['total_hits'] == 1:
            ...
            updated_barcode = initial_top_container['barcode'].replace("IM ", "T")
